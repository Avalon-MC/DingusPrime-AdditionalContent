package net.petercashel.dingusprimeacm.kubejs.types.cabnet.client;
...
public class CabnetScreen extends AbstractContainerScreen<CabnetContainer> {
    private final ResourceLocation GUI = new ResourceLocation("kubejs", "textures/gui/cartshelf_gui.png");

    public CabnetScreen(CabnetContainer container, Inventory inv, Component name) {
