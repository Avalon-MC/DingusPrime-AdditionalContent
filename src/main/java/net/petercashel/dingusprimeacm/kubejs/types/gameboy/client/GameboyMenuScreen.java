...
public class GameboyMenuScreen extends AbstractContainerScreen<GameboyMenu> {
    ...
    public static GameboyMenuScreen lastInstance;
    public GameboyEmulator emulator;
    GameboyStatus gbStatusCurrent = GameboyStatus.NewEmulator;
    int statusTicks = -1;
    public String GameID;

    public GameboyMenuScreen(GameboyMenu container, Inventory inv, Component name) {
    ...
    public void SetupEmulator(String GameID, String CartUUID)
    {
        ...
        if (rom != null) {
            try {
                ...
                GBSaveReqPacket_CS saveRequest = new GBSaveReqPacket_CS(CartUUID);
    ...
    public boolean keyPressed(int pKeyCode, int pScanCode, int pModifiers)
    {
        ...
        if (DingusPrimeAdditionalContentMod_Client.HandlePressed(pKeyCode, pScanCode, pModifiers)) {
            return true;
        }
    ...
    public boolean keyReleased(int pKeyCode, int pScanCode, int pModifiers) {
        if (DingusPrimeAdditionalContentMod_Client.HandleReleased(pKeyCode, pScanCode, pModifiers)) {
            return true;
        }
